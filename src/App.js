    ...
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="row-right">
            <div class="project">
              ...
              <h5>
                Trouble shooting<span class="period-mark">.</span>
              </h5>
              <h6>
      ...
      <section>
        ...
        <div class="other">
          ...
          <p>
            개요: 디지털 기술 사용이 어려운 고령층의 문제를 분석하고, 디지털
            접근성을 높이기 위한 해결책을 제안
          </p>
          <p>
            역할: 수집한 데이터를 Brightics AI를 활용한 데이터 정제, 시각화,
            통계 검증, 머신러닝으로 지인의 도움 여부와 디지털 기술 역량 간에는
            유의미한 상관관계가 있었으며, 가족 및 친구의 지원이 노령층의 디지털
            학습 속도와 활용 능력 향상에 주요한 영향을 미친다는 인사이트 도출
          </p>
          <p>
            성과: 분석 결과를 바탕으로 AI 비서 "부손이" 및 지역 연계형 디지털
            교육 프로그램 제안
          </p>
          <p>
            배운 점: Brightics AI를 활용한 데이터 정제와 시각화를 진행하며,
            대규모 데이터를 효율적으로 처리하고 패턴을 시각적으로 탐구하는
            역량을 키웠습니다. 특히, Brightics의 다양한 기능을 활용해 분석
            속도를 높이고 데이터의 신뢰성을 확보할 수 있었습니다.
          </p>
        </div>
        <div class="other">
          <h3>
